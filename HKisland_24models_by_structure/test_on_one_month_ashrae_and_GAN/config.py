...
gen_a_cl_save_path = '../../GAN_models/{}_ashrae_{}_to_{}_cl.pt'.format(GAN_building_name, source_context, target_context)
gen_b_cl_save_path = '../../GAN_models/{}_ashrae_{}_to_{}_cl.pt'.format(GAN_building_name, target_context, source_context)
